 ...
 *
 *        Version:  1.0
 *        Created:  04/18/2019 08:38:16 AM
 *       Revision:  none
 *       Compiler (C):    gcc PlaylistNode.cpp -o PlaylistNode.cpp.out
 *       Compiler (C++):  g++ PlaylistNode.cpp -o PlaylistNode.cpp.out
 *
...
PlaylistNode::PlaylistNode() 
{
    ...
    this->songLength = 0;
    this->nextNodePtr = 0; // set ponter to "NULL" or "0"
    return;
}
