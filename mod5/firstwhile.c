 ...
 *
 *        Version:  1.0
 *        Created:  02/07/2019 09:24:18 AM
 *       Revision:  none
 ...
 */
#include <stdio.h>
#include <stdbool.h> // for true nad false variables
// Constants
#define MINCOUNT 2
#define MAXCOUNT 5
#define MINGRADE 0
...
int main()
{
    ...
    // Task 5: Support multiply student entreis. Calculate class average
    ...
    while(student_count <= MAXSTUDENTS)      //loop over students
    {
        ...
        {
            printf("%d is lower than %d. Setting you enter to %d\n",
                    hw_count, MINCOUNT, MINCOUNT);
            hw_count = MINCOUNT;
        }
        if(hw_count > MAXCOUNT)
        {
            printf("%d is greater than %d. Setting you entry to %d\n",
