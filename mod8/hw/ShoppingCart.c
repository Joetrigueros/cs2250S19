 ...
 *
 *        Version:  1.0
 *        Created:  03/26/2019 09:11:43 AM
 *       Revision:  none
 ...
 *         Arg2:  ItemsToPurchase pointer/address
 *         Arg1:  ShoppingCart pointer/address
 *       Return:  ShoppingCart variable (by value)
 * =====================================================================================
 */
ShoppingCart AddItems(ItemToPurchase* item, ShoppingCart* cart)
{
    return *cart;  // dereference the pointer to returnt the values of the structure
}
/* ===  FUNCTION  ======================================================================*         Name:  AddItems
 *         Name:  RemoveItems
 *         Arg2:  Remove an ItemsToPurchase 
 *         Arg1:  ShoppingCart pointer/address
 *       Return:  ShoppingCart variable (by value)
 * =====================================================================================
 */
