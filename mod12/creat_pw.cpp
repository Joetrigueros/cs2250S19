 ...
 *
 *    Description:  Creat a password, and valided it:
 ...
 *       Revision:  none
 *       Compiler (C):    gcc creat_pw.cpp -o creat_pw.cpp.out
 *       Compiler (C++):  g++ creat_pw.cpp -o creat_pw.cpp.out
 *
...
int main(int argc, char* argv[])
{
    ...
    while(!valid_password)
    {
        ...
        {
            if(ispunct(c)) // check for any special
            {
                special_char = true;
